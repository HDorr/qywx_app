...
import com.ziwow.scrmapp.tools.utils.Config;
...
public abstract class BaseController {
	...
	protected Map<String, Object> rtnParam(Integer errorCode, Object data) {
		// 正常的业务逻辑
		if (errorCode == 0) {
			return ImmutableMap.of("errorCode", errorCode, "data",(data == null) ? (Object) Config.props.getProperty(String.valueOf(errorCode)) : data);
		} else {
