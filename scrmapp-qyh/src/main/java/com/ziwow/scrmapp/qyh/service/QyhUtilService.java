 ...
 * 
 */
@Service("qyhUtilService")
public class QyhUtilService {

	private static final Logger log = Logger.getLogger(QyhUtilService.class);
	...
	public String getQyhAccessToken() {
		...
		String tokenUrl = String.format(QyhConstant.ASSESS_TOKEN_URL, sCorpID, qyhCorpSecret);
		String KEY = RedisKeyConstants.QYH_CORP_ACCESS_TOKEN + sCorpID;
