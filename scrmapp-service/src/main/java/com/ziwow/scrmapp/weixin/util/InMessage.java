...
import com.ziwow.scrmapp.weixin.enums.MsgTypes;
...
public class InMessage implements Serializable {
    ...
    private String ConsumeSource; // 核销来源
    private String UserCardCode;  // 卡券Code码
    private String StaffOpenId;	  // 核销该卡券核销员的openid
    private String SessionFrom;//开发者在客服会话按钮设置的sessionFrom参数
	...
	public void setOriginalXMLString(String originalXMLString) {
