...
public class BasicInfoBean {
  ...
  /**
   * birthday : buy_service_cards : [] user_name : 尹民毫（管理员测试号） sex : 男 buy_filters : [] buy_devices
   * : [[{"name":"保修到期时间","value":"-"}, {"name":"设备管理中心","value":"-"},
   * {"name":"购买日期","value":"2016-11-18"}, {"name":"产品大类","value":"纯水机"},
   * {"name":"产品条码","value":"112"}, {"name":"设备服务网点","value":"-"}, {"name":"购买渠道","value":"-"},
   * {"name":"产品编码","value":"104043-0001"}, {"name":"安装日期","value":"-"},
