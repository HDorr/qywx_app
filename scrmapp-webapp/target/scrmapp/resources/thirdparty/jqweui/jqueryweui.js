...
(function($) {
  ...
  $.getTranslate = function(el, axis) {
    ...
    if (window.WebKitCSSMatrix) {
      ...
      transformMatrix = curStyle.MozTransform || curStyle.OTransform || curStyle.MsTransform || curStyle.msTransform || curStyle.transform || curStyle.getPropertyValue('transform').replace(/translate\(|translate3d\(/g, 'matrix(1, 0, 0, 1,');
...
+ function($) {
  ...
  defaults = $.fn.select.prototype.defaults = {
    ...
    radioTemplate: '<div class="weui-cells weui-cells_radio">\
        {{#items}}\
    ...
    checkboxTemplate: '<div class="weui-cells weui-cells_checkbox">\
        {{#items}}\
        <label class="weui-cell weui-check_label" for="weui-select-id-{{this.title}}">\
          <div class="weui-cell__bd weui-cell_primary">\
            <p>{{this.title}}</p>\
...
+ function($) {
  ...
  $.fn.calendar = function(params, args) {
    ...
    return this.each(function() {
      ...
      if (!calendar) {
        if (typeof params === typeof "a") {} else {
