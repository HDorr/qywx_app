...
<head>
    ...
    <link rel="stylesheet" href="${f_ctxpath}/resources/src/css/reserveService/reserveService_maintain.css${f_ver}">
</head>
<body>
...
<script type="text/html" id="addressInfo_template">
    ...
    <div class="info-box">
        <div class="userAvatar">
            <img src="{{data.headimgurl || '/resources/images/myOrder/workerHead.png'}}">
        </div>
        <div class="userText">
...
<script type="text/html" id="reserveInfo_template">
    <header class="title">
        ...
        <div class="uploadImg">
            <p>上传图片: <span>(最多上传三张)</span></p>
            <div class="imgContainer">
                <div class="imgBox" data-index="0">
                    <i class="cancelIcon" data-index="0"></i>
                    <img class="image image_0" src="">
                </div>
                <div class="imgBox" data-index="1">
                    <i class="cancelIcon" data-index="1"></i>
                    <img class="image image_1" src="">
                </div>
                <div class="imgBox" data-index="2">
                    <i class="cancelIcon" data-index="2"></i>
                    <img class="image image_2" src="">
                </div>
            </div>
        </div>
</script>
...
<script src="${f_ctxpath}/resources/src/js/reserveService/reserveService_maintain.js${f_ver}"></script>
</body>
</html>