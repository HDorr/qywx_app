        ...
        <script  id="orderDetailTemplate" type="text/html">
            ...
            <div class="order_info">
                ...
                <div class="description">
                    <span class="pull-left">故障描述：</span>
                ...
                {{if repairItemRecord}}
                <div class="description">
                    <span class="pull-left">维修措施：</span>
                    <span class="pull-left con">{{repairItemRecord}}</span>
                </div>
                {{/if}}

                {{if repairPartRecord}}
                <div class="description">
                    <span class="pull-left">维修配件：</span>
                    <span class="pull-left con">{{repairPartRecord}}</span>
                </div>
                {{/if}}
            </div>
                <div class="order_info">
