...
<html>
    ...
    <body>
        ...
        <script src="${f_ctxpath}/resources/src/js/addressManage/addressManageTemplate/build/template.js${f_ver}"></script>
        <script src="${f_ctxpath}/resources/src/js/jdLikeAddrChose.js${f_ver}"></script>
        <script src="${f_ctxpath}/resources/src/js/addressManage/addressList_old.js${f_ver}"></script>
        <script>
            shieldShare();
