...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${f_ctxpath}/resources/src/css/workOrderOperation/unfinishedOrderDetail_repair.css${f_ver}">
    </head>
    <body>
        ...
        <script type="text/x-template" id="basicInfo_template">
            <div class="infoBox">
                ...
                <div class="line" v-if="data.faultImage">
                    <span>
                        <i  class="faultImage" 
                            v-for="(src,index) in data.faultImage.split(',')" 
                            :key="index"
        ...
        <script src="${f_ctxpath}/resources/src/js/workOrderOperation/unfinishedOrderDetail_repair.js${f_ver}"></script>
    </body>
</html>