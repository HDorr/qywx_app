            ...
            <li>
                ...
                <div class="operation">
                    <div class="btnBox pull-right">
                        ...
                        <%--{{/if}}--%>
                        <button data-confirmstatus="{{(v.confirmStatus==null||v.confirmStatus == 0)?1:v.confirmStatus}}" data-orderscode="{{v.ordersCode}}" data-ordersid="{{v.id}}" data-ordertype="{{v.orderType}}" data-contacts="{{v.userName}}" data-contactsmobile="{{v.userMobile}}" onclick="cofirmOrder(this)">{{v.confirmContent}}</button>
                    </div>
                </div>
            </li>
            {{/each}}
