<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="${f_ctxpath}/resources/src/css/jqweui/jquery-weui.css${f_ver}">
        <link rel="stylesheet" href="${f_ctxpath}/resources/src/css/bindProduct/noQrCodeBindPdt.css${f_ver}">
    </head>

    <body>
        <div class="main_layer container">
            <div class="scanArea clearfix">
                <p class="pull-left">
                    产品型号
                    <input class="qy-input-360" id="show_content" style="margin-left:0.266667rem" type="text" >
                    
                    <!--<a href="javascript:;">如何查找产品条码？</a>-->
                </p>
                <div class="autoChose qy-btn-180 pull-right" id="select_content">
                    自动选择
                </div>
            </div>
        ...
        <script src="${f_ctxpath}/resources/src/js/bindProduct/noQrCodeBindPdt.js${f_ver}"></script>
    </body>
