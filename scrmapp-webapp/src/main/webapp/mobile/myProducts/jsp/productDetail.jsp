...
<head>
    ...
    <link rel="stylesheet" href="${f_ctxpath}/resources/src/css/myProducts/productDetail.css${f_ver}">
</head>

<body>
    <div class="main_layer">
        <div class="weui-loadmore" style="padding-top: 40%">
    ...
    <script src="${f_ctxpath}/resources/src/js/myProducts/productDetail.js${f_ver}"></script>
</body>
