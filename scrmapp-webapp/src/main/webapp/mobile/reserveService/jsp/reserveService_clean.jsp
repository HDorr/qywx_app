...
<head>
    ...
    <link rel="stylesheet" href="${f_ctxpath}/resources/src/css/reserveService/reserveService_clean.css${f_ver}">
</head>
<body>
...
<script src="${f_ctxpath}/resources/src/js/reserveService/reserveService_clean.js${f_ver}"></script>
</body>
</html>