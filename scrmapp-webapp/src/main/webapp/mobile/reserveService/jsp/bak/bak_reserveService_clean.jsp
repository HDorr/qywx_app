<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <head>
        ...
        <link rel="stylesheet" href="${f_ctxpath}/resources/src/css/reserveService/reserveService.css">
    </head>
    <body>
            ...
            <section class="content reserveCon"style="background:#fff" >
                ...
                <div class="reserveTime">
                    ...
                    <div class="chooseTime">
                        ...
                        <!-- <div>
                            <input id="orderTime" type="text" placeholder="请填写上门服务时间！">
                ...
                <div class="installDescription">
                    ...
                    <div class="textareaBox">
                        <textarea id="description" name="" id="" cols="30" rows="5" placeholder="如有其他需要特别说明，请填写！"></textarea>
                    </div>
