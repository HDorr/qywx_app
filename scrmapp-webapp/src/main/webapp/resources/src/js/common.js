...
var queryUrls =
    ...
    qyhCancelSingleOrder_repair_maintain:rootPath + "/scrmapp/qyhuser/orders/cancelSingle/repair_maintain",//维修或保养单取消单个产品
...
var confirmModal = {
    //安装单
    htmlStrWithTextArea1: '<div class="mainContainer">' +
        '<div class="mcmheader">' +
        ...
        '<option value="不具备安装条件">不具备安装条件</option>'+
        ...
        '</div>',
    //维修单
    htmlStrWithTextArea2: '<div class="mainContainer">' +
        '<div class="mcmheader">' +
        '<i onclick="confirmModal.closeModal()">X</i>' +
        '</div>' +
        '<div class="mcmbody">' +
        ...
        '</div>',
    //保养单
    htmlStrWithTextArea3: '<div class="mainContainer">' +
        '<div class="mcmheader">' +
        '<i onclick="confirmModal.closeModal()">X</i>' +
        '</div>' +
        '<div class="mcmbody">' +
