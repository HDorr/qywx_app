...
var app = new Vue({
    ...
    methods: {
        ...
        completeProductHandler:function(product){
            ...
            location.href = pageUrls.unfinishedWorkOrderDetail_repair_detail + "?userId=" + USERID + "&ordersCode=" + ORDERSCODE
        },
