...
/**
 * 
 * ClassName: UniqueIDBuilder <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * date: 2014-11-11 下午5:28:28 <br/>
 *
 * @author hogen
 * @version 
 * @since JDK 1.6
...
public class UniqueIDBuilder {
	...
	private UniqueIDBuilder() {
	}

	public static String classID(Class<?> clz, Object id) {
		return clz.getName() + AT + id;
	}
