...
public class RequestHandler {
	 ...
	 * 初始化函数。
	 */
	public void init(String app_id, String api_secret,	String mch_key) {
		this.last_errcode = "0";
		this.Token = "token_";
		this.debugInfo = "";
		this.appid = app_id;
		this.partnerkey = mch_key;
		this.appsecret = api_secret;
		this.key = mch_key;
	}
	...
	// 获取package的签名包
	public String genPackage(SortedMap<String, String> packageParams, String key)
