...
import com.ziwow.scrmapp.wechat.utils.ClientMultiThreadedExecution;
...
public class WechatMsgAction {
    ...
    private static final String MASS_PREVIEW_URL = "https://api.weixin.qq.com/cgi-bin/message/mass/preview?access_token=";
    ...
    private static final String TEMPLATE_GET_ID = "https://api.weixin.qq.com/cgi-bin/template/api_add_template?access_token=";
    Logger logger = LoggerFactory.getLogger(WechatMsgAction.class);
    /**
     * 发送客服消息
     * @param accessToken
     * @param message
     ...
     */
    public JSONObject massSendall(String accessToken,String groupId,String mpNewsMediaId) throws KeyManagementException, NoSuchAlgorithmException, NoSuchProviderException, IOException, ExecutionException, InterruptedException{
    	Map<String,Object> json = new HashMap<String,Object>();
     ...
     * @since JDK 1.6
     */
    public JSONObject massPreview(String accessToken,String openid,String mpNewsMediaId) throws IOException, ExecutionException, InterruptedException{
    	Map<String,Object> json = new HashMap<String,Object>();
    	Map<String,Object> mpnews = new HashMap<String,Object>();
    	mpnews.put("media_id", mpNewsMediaId);
    	json.put("touser", openid);
    	json.put("mpnews", mpnews);
    	json.put("msgtype", "mpnews");
    	String reslut = HttpKit.post(MASS_PREVIEW_URL.concat(accessToken), JSONObject.toJSONString(json));
    	if (StringUtils.isNotEmpty(reslut)) {
			return JSONObject.parseObject(reslut);
		}
		return null;
     ...
     * @throws IOException
     */
    public JSONObject massSend(String accessToken,String[] openids,String mpNewsMediaId) throws IOException, ExecutionException, InterruptedException {
    	Map<String,Object> json = new HashMap<String,Object>();
    	Map<String,Object> mpnews = new HashMap<String,Object>();
    	mpnews.put("media_id", mpNewsMediaId);
    ...
    public JSONObject massTextSend(String accessToken,String[] openids,String content) throws IOException, ExecutionException, InterruptedException {
    	Map<String,Object> json = new HashMap<String,Object>();
    	Map<String,Object> mpnews = new HashMap<String,Object>();
     ...
     * @throws ExecutionException 
     */
    public JSONObject massSend(String accessToken,String msgid) throws KeyManagementException, NoSuchAlgorithmException, NoSuchProviderException, IOException, ExecutionException, InterruptedException{
    	Map<String,Object> json = new HashMap<String,Object>();
	 ...
	 * @throws KeyManagementException
	 */	
	public void templateSend(String accessToken, TemplateData data)
			throws IOException, ExecutionException, InterruptedException,
			KeyManagementException, NoSuchAlgorithmException,
			NoSuchProviderException {
		logger.info("发送模板消息的accessToken=" + accessToken + ",模板数据data=" + JSON.toJSONString(data));
		ClientMultiThreadedExecution.httpPost(TEMPLATE_SEND_URL.concat(accessToken), net.sf.json.JSONObject.fromObject(data).toString());
	}
	
	/**
	 * 
	* @Title: templateGet
	* @Description: TODO(获取模板消息ID)
	...
	* @throws
	 */
	public JSONObject templateGet(String accessToken, String template_id_short)
			throws IOException, ExecutionException, InterruptedException,
			KeyManagementException, NoSuchAlgorithmException,
			NoSuchProviderException{
		Map<String,Object> json = new HashMap<String,Object>();
		json.put("template_id_short", template_id_short);
		String result = HttpKit.post(TEMPLATE_GET_ID.concat(accessToken),JSONObject.toJSONString(json));
